package CreationalDesignPattern.PrototypePattern.Problem;

public class GameClientWithoutPrototype {

    public GameClientWithoutPrototype(){
        System.out.println("This is GameClientWithoutPrototype Constructor");
    }
